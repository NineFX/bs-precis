...
function testBuilder(elem) {
  try {
    Jest.test(elem[/* profile */0] + (" Test: " + listToString(PrecisUtils$BsPrecis.toCodePointList(elem[/* input */1]))), (function (param) {
    ...
    if (exn[0] === PrecisUtils$BsPrecis.PrecisError) {
      switch (exn[1]) {
        case 0 : 
            console.log("Disallowed Error");
            return /* () */0;
        case 1 : 
            console.log("Unassigned Error");
            return /* () */0;
        case 2 : 
            console.log("Unicode  Error");
            return /* () */0;
        case 3 : 
            console.log("Bidirection Error");
            return /* () */0;
        case 4 : 
